<div align="center">
  ...
  <img src="https://komarev.com/ghpvc/?username=yashyp12&label=Profile%20Views&color=00D9FF&style=for-the-badge" alt="Profile Views" />
</div>
...
```javascript
const yash = {
  currentFocus: "Advanced Java & Modular Architecture",
  learning: ["Cloud Fundamentals", "SDLC Best Practices", "System Design"],
  askMeAbout: ["Java", "Electron.js", "Freelancing", "Full-Stack Development"],
  technologies: {
    backend: ["Java", "Python", "SQL"],
    frontend: ["JavaScript", "HTML5", "CSS3", "Bootstrap"],
    databases: ["MySQL", "SQLite", "Firebase"],
    tools: ["Git", "Electron.js", "VS Code"]
  },
  funFact: "Everything is Easy! 💪"
};
```
...
<div align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=yashyp12&theme=tokyonight&border=00D9FF&ring=00D9FF&fire=00D9FF&currStreakLabel=00D9FF" alt="GitHub Streak" />
</div>
  ...
  <tr>
    <td width="50%">
      ...
      <div align="center">
        ...
        <p align="left">
          ⚡ <strong>Challenge:</strong> Client relied on manual paper logging for furnace data, leading to errors and slow reporting.<br/>
          ✨ <strong>Solution:</strong> Built a cross-platform desktop app to automate data entry and generate Excel reports.<br/>
          🎯 <strong>Impact:</strong> Reduced manual workload and significantly improved data reliability for supervisors.
        </p>
      </div>
    </td>
    <td width="50%">
      ...
      <div align="center">
        ...
        <p align="left">
          🎨 Designed a clean UI for local vendors to manage pickup requests.<br/>
          🔒 Implemented <strong>Firebase Authentication</strong> for secure user access.<br/>
  ...
  <tr>
    <td width="50%">
      ...
      <div align="center">
        ...
        <p align="left">
          🚀 A performance-optimized digital space showcasing my development journey and projects.<br/>
          📱 Fully responsive design with modern UI/UX principles.<br/>
    ...
    <td width="50%">
      ...
      <div align="center">
        <p align="left">
          🌱 Currently building more exciting projects...<br/>
          💡 Working on Cloud-based solutions and System Design implementations.<br/>
          📚 Exploring modern architectures and best practices.
        </p>
      </div>
    </td>
  </tr>
...
### 💭 _"Keep exploring. Keep building. And say **Everything is Easy!**"_ 💪
...
<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=00D9FF&center=true&vCenter=true&width=435&lines=Thanks+for+visiting!+%F0%9F%91%8B;Let's+build+something+amazing!+%F0%9F%9A%80;Connect+with+me!+%F0%9F%A4%9D" alt="Typing SVG" />
</div>
